...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ImageButton imageButton = findViewById(R.id.Video_Promo);  // Reemplaza "miImageButton" con el ID de tu ImageButton

// Asigna un evento onClick al ImageButton
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Coloca el código que deseas ejecutar cuando se hace clic en el ImageButton aquí
                // Por ejemplo, puedes iniciar una nueva actividad
                Intent intent = new Intent(MainActivity.this, VideosInsti.class);
